...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { location_id: @area.location_id, name: @area.name, year_established: @area.year_established } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { location_id: @area.location_id, name: @area.name, year_established: @area.year_established } }
